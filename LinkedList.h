/*	@file		LinkedList.h
 * 	@author		Mustafa Yuşa Yenmez, yusayenmez@gmail.com
 * 	@date		October 6,2021	->	First Release
 *             		October 6,2021  ->	Move Constructor added
...
*/
template <typename T>
LinkedList<T>::LinkedList(const T& Data) : Head(nullptr), Tail(nullptr), Size(0)
{
    Node* Iter = new Node;
...
/*
 *  @brief  The list is initialized with another list
 *  @param  List    :Another object of the same class to initialize the object
*/
template <typename T>
 ...
 *  @param  List    :locally created list
 *
*/
template <typename T>
LinkedList<T>::LinkedList(LinkedList<T>&& List):Head(List.Head),Tail(List.Tail),Size(List.Size)
{
    List.Head = nullptr;
    List.Tail = nullptr;
    List.Size = 0;
